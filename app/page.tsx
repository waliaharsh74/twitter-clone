          ...
          <div className='border border-l-0 border-r-0 border-gray-600 p-5 hover:bg-slate-900 transition-all cursor-pointer'>
            <div className="grid grid-cols-12 gap-2">
              ...
              <div className='col-span-10'>
                ...
                <textarea className="border-b h-10 w-full bg-transparent text-xl p-3" placeholder="What's happening?" rows={6} id=""></textarea>
                <div className="mt-2 flex justify-between items-center ">

                  <BiImageAlt onClick={handleSelectImage} className="text-2xl" />
                  <button className="bg-[#1d9bf0] text-sm px-4 py-2 mt-4 rounded-full  ">Tweet</button>
                </div>
